...
st.header('Teleport', divider='rainbow')
# with st.expander("Chat not showing up?"):
#     st.write("Complete the fields for your first context, and then click back into the chat.")
